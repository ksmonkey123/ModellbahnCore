...
public class Left_C_Operator extends AOperator {
	...
	public void update(@NonNull Model model) {
		...
		if (curr == null) {
			// base mode
			if (this._C_solo.evaluate(model))
